...
export const metadata: Metadata = {
  ...
  description: "Discover your dream car with CarShop - offering a wide selection of luxury vehicles.",
  openGraph: {
    title: "Welcome to CarShop",
    description: "Discover your dream car with CarShop - offering a wide selection of luxury vehicles.",
    url: "",
    siteName: "CarShop",
    images: [{ url: "https://images.pexels.com/photos/17632052/pexels-photo-17632052.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" }],
    type: "website",
  },
  twitter: {
    ...
    title: "Welcome to CarShop",
    description: "Discover your dream car with CarShop - offering a wide selection of luxury vehicles.",
    images: ["https://images.pexels.com/photos/17632052/pexels-photo-17632052.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
  robots: {
    index: true,
    follow: true,
